...
export default function WelcomeSplashPage() {
  ...
  return (
    <div className="min-h-screen bg-background flex flex-col items-center justify-center p-4">
      <div className="w-full max-w-4xl bg-white rounded-3xl shadow-2xl overflow-hidden flex flex-col md:flex-row h-auto md:min-h-[600px]">
        {/* Illustration/Image */}
              ...
              {splashScreens.map((screen, index) => (
                <CarouselItem key={index}>
                  <div className="space-y-4 sm:space-y-6 animate-in fade-in slide-in-from-right-4 duration-500">
                    <div className={cn("w-16 h-16 sm:w-20 sm:h-20 rounded-2xl flex items-center justify-center", screen.color)}>
                      {screen.icon}
                    </div>
